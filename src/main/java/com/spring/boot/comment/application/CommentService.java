...
public class CommentService {
    ...
    public CommentService(CommentRepository commentRepository, PostRepository postRepository, ConnectionService connectionService, MemberService memberService) {
    ...
    public Comment createComment(Long writerId, String body, Long postId) {
        ...
        return postRepository.findById(postId)
                .map(findPost -> {
                    ...
                    if(!connectionService.checkMemberFollowsTargetMember(writerId, postWriter.getId())){
                        throw new NotConnectedException(Member.class, writerId, "doesn't follow", postWriter.getId());
                    }
