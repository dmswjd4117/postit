...
public class PostQueryService {
  ...
  public PostInfoDto getPostByPostId(Long postId, Long readerId) {
    if (!checkMemberAccessAuth(postId, readerId)) {
      throw new PostAccessDeniedException();
    }
    return PostInfoDto.from(
  ...
  @Transactional(readOnly = true)
  public List<PostInfoDto> getPostByWriterId(Long writerId, Pageable pageable, Long readerId) {
  ...
  @Transactional(readOnly = true)
  public List<PostInfoDto> getFollowingsPost(Long memberId, Pageable pageable) {
  ...
  @Transactional(readOnly = true)
  public List<PostInfoDto> getPostByTags(List<String> tagNames, Pageable pageable, Long readerId) {
  ...
  @Transactional(readOnly = true)
  public List<HomeFeedPostDto> getHomeFeedPost(Long memberId, int pageSize, Long postId) {
    return postRepository.getHomeFeedPost(memberId, pageSize, postId).stream()
        .map(HomeFeedPostDto::from)
        .collect(Collectors.toList());
  }
}
