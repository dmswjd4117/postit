...
public class SecurityConfig {
  ...
  public SecurityConfig(FormAccessDeniedHandler formAccessDeniedHandler,
      FormAuthenticationEntryPoint formAuthenticationEntryPoint) {
...
//              .antMatchers("/api/post/**").hasAnyRole(RoleName.ADMIN.name(), RoleName.MEMBER.name())
        ...
        .failureHandler((request, response, exception) -> {
          ApiResult<?> LOGIN_FAIL_EXCEPTION = ApiResult.error(exception.getMessage(),
